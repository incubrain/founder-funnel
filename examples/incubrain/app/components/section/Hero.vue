  ...
  >
    ...
    >
      ...
      >
        ...
        />
        <div
          class="relative rounded-xl bg-default border border-default p-2 shadow-2xl ring-1 ring-inverted/10 transform transition-transform duration-700 hover:scale-[1.01]"
        >
          <NuxtImg
            :src="media.src"
            :alt="media.alt"
