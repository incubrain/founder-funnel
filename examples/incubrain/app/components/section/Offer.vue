...
<template>
  ...
  >
    <div class="absolute top-0 inset-0 bg-grid-white/[0.02] pointer-events-none z-0" />
    <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
      <div class="w-[80%] h-[80%] bg-primary-500/10 rounded-full blur-3xl" />
    </div>

    <div class="grid lg:grid-cols-[1fr_400px] gap-8 lg:gap-12 relative z-10 items-start">
      <div
        v-if="founder"
