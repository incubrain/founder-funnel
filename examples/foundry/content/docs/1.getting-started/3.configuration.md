...
See the [full navigation configuration](/docs/content/navigation) for all available fields.
...
See the [full app config shape and override examples](/docs/reference/app-config) for details.
