...
Nuxt layers support component overriding. To customize any layer component, create a file with the same name and path in your app:
...
Your component completely replaces the layer's version. There is no partial override — you own the entire component.
...
These are used by the [VRT system](/docs/testing/visual-regression) to screenshot and compare components.
