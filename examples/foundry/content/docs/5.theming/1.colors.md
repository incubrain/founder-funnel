...
Foundry uses [oklch color space](https://oklch.com){target="_blank"} for perceptually uniform colors. The three values are lightness (0–1), chroma (saturation), and hue (0–360).

**Tools:** [oklch.com](https://oklch.com) — Interactive color picker • [Color palette generator](https://huetone.ardov.me/)
...
The color mode toggle is in the header (when `showColorMode: true` in navigation config). See [Nuxt UI color modes](https://ui.nuxt.com/getting-started/theme#color-mode){target="_blank"} for details.

## Tools

- [oklch.com](https://oklch.com){target="_blank"} — Interactive color picker
- [Tailwind CSS Colors](https://tailwindcss.com/docs/customizing-colors){target="_blank"} — Tailwind v4 color reference
- [Nuxt UI Theming](https://ui.nuxt.com/getting-started/theme){target="_blank"} — Nuxt UI theme documentation

See [App config color overrides](/docs/reference/app-config#ui-colors) for runtime color configuration.
