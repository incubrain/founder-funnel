...
:read-more{title="Composables API reference" to="/docs/reference/composables#event-tracking"}
:read-more{title="Signal capture components" to="/docs/signal-capture"}
