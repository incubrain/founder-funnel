...
- **visual-tester** -- UI/UX visual bug detection using `agent-browser` annotated snapshots. See [Agent Configurations](/docs/advanced/agent-configurations#visual-testing-workflow) for usage
...
For detailed agent configuration profiles (Manager, Implementer, Reviewer, Debugger, Browser Tester, etc.), see [Agent Configurations](/docs/advanced/agent-configurations).
...
5. (Optional) Configure [Agent Profiles](/docs/advanced/agent-configurations) in VibeKanban for multi-agent workflow
