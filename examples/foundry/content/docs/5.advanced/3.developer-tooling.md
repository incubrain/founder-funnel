...
description: AI-assisted development workflow with Claude Code and agent skills.
---
...
- **visual-tester** -- UI/UX visual bug detection using `agent-browser` annotated snapshots
