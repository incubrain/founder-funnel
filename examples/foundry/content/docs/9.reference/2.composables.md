...
::field-group
  ::field{name="feedUrl" type="ComputedRef<string>"}
  Full RSS feed URL.
  ::

  ::field{name="actions" type="ComputedRef<RssAction[]>"}
  Available RSS reader actions.
  ::

  ::field{name="handleSelect" type="(option: RssAction | null) => void"}
