...
|---|---|---|---|
| `fields` | `FieldDef[]` | Email field | Form field definitions |
| `location` | `string` | — (required) | Tracking location identifier |
| `submitLabel` | `string` | `'Get Access'` | Submit button text |
| `note` | `string` | — | Helper text below form |
| `layout` | `'stacked' \| 'horizontal'` | `'stacked'` | Field layout direction |
