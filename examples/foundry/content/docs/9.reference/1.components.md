...
The layer ships 45 components organized by function. All components follow the [complexity budget](/docs/getting-started#complexity-budget): max 50 lines, max 5 props, max 2 abstraction layers.
