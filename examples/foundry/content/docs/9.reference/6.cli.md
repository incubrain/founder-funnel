...
|---|---|---|
| `directory` | `my-funnel` | Project directory name |
...
```bash
# Create with defaults (./my-funnel, default template)
pnpm create foundry

# Specify directory
pnpm create foundry my-saas-funnel
...
4. Deploy — see [Deployment](/docs/deployment/overview)
