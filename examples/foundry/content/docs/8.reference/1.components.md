...
The layer ships 50+ components organized by function across the core layer and opt-in modules. All components follow the [complexity budget](/docs/getting-started#complexity-budget): max 50 lines, max 5 props, max 2 abstraction layers.
