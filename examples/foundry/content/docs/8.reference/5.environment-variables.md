...
| `NUXT_FOUNDRY_REGISTER` | core | Registration | Server | No | Set to `true` to auto-register with the Incubrain mentorship network on production startup. Sends site URL, MCP endpoint, and RSS feeds. |
...
export default defineNuxtConfig({
  runtimeConfig: {
    ...
    foundryRegister: false, // ← NUXT_FOUNDRY_REGISTER
