...
| `VRT_UPDATE` | [vrt](/docs/modules/vrt) | Testing | Test | No | Set automatically by `pnpm test:vrt:update` to update VRT baselines. |
| `VRT_DEBUG` | [vrt](/docs/modules/vrt) | Testing | Test | No | Enable VRT server debug logging. |
