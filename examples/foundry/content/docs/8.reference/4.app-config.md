...
The `useContentConfig()` composable uses this mapping at runtime to resolve routes to collections. See [Composables Reference](/docs/reference/composables#usecontentconfig).
