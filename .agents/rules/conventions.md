...
**Sections** (auto-generated by SectionWrapper via `section-id` prop):
```
section-benefits
section-hero
section-faq
...
Always derived from component type. SectionWrapper and convert components set these automatically — no manual work needed.
