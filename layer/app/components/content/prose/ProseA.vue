...
// Auto-detect internal links: relative/absolute paths (not starting with http:// or https://)
...
// Resolve internal paths with correct collection prefix
const internalHref = computed(() => {
  if (!isInternalLink.value) return props.href
  if (props.href.startsWith('/')) return props.href
  return resolveInternalPath(props.href, currentCollection.value)
})
