...
**Navigation Rules**:
- Every docs subdirectory requires `navigation.yml`
- Icon should be a Lucide icon (i-lucide-*)
- Title should be short and descriptive (2-3 words max)
- DO NOT create `index.md` files in subdirectories (causes conflicts with navigation.yml)
- Use numbered files (00.overview.md, 01.file.md, etc.) or named files (introduction.md, etc.)
- When navigating to a directory path (e.g., /docs/getting-started), the system auto-redirects to the first file
